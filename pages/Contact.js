...
return (
    <>
    <Navbar />
<div className="container contact"   no-repeat>
    <div className="row">
        <div className="col-md-8 col-12 mx-auto">
            <div className="card shadow-lg border-0 p-2">
                <h1 className="text-center bg-dark text-white display-10 d-inline-block">Contact us</h1>
                ...
                <div className="mt-5 col-md-6 col-12 mx-auto">
                    <button className="btn btn-outline-dark btn-sm btn-block">Send Message</button>
                </div>
            </div>
        </div>
    </div>
